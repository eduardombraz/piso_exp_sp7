...
def update_packing_google_sheets(csv_file_path):
    try:
        ...
        sheet1 = client.open_by_url("https://docs.google.com/spreadsheets/d/10hyfLG3fot5plg9VM5EpcmUkKWUA_SAQ9R-1oUyFkJg/edit?gid=1676967591#gid=1676967591")
...
async def main():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.locator('xpath=//*[@placeholder="Ops ID"]').fill('Ops112425')
